    ...
    <div class="space-y-6">
        ...
        <div class="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-700 rounded-lg p-6">
            <div class="flex items-center justify-between mb-6">
                ...
                <flux:badge color="green">{{ $following->total() }}</flux:badge>
            </div>
            ...
            <div class="space-y-3">
                @forelse($following as $followedUser)
                    <div class="flex items-center justify-between p-3 rounded-lg hover:bg-zinc-50 dark:hover:bg-zinc-900/50">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <div class="font-medium">{{ $followedUser->name }}</div>
                                <div class="text-sm text-zinc-500">{{ $followedUser->email }}</div>
                            </div>
                        </div>
                ...
                @empty
                    <div class="text-center py-12">
                        ...
                        <h3 class="text-sm font-medium mt-4">Not following anyone yet</h3>
