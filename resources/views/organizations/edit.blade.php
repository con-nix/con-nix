<x-layouts.app :title="__('Edit Organization')">
    <div class="mb-8">
        ...
        <p class="mt-1 text-neutral-600 dark:text-neutral-400">Update your organization details</p>
    </div>
    ...
    <div class="mx-auto max-w-3xl">
        <form action="{{ route('organizations.update', $organization) }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <x-text-input id="name" name="name" type="text" class="mt-1 block w-full" :value="old('name', $organization->name)" required autofocus />
